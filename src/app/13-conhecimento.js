...
const MODELOS_CONHECIMENTO = [
  ...
  { nome: 'Física com unidades', quando: 'física, velocidade, aceleração, força, energia, trabalho, potência, eletricidade, circuito, óptica, ondas, termologia, cinemática, dinâmica',
    instrucoes: 'Liste os dados com as unidades (no SI), escolha a fórmula e diga por que ela vale, converta as unidades antes de calcular e faça a conta passo a passo. Confira se a unidade final faz sentido e se o valor é razoável. Termine com a resposta em negrito, com unidade.' },
  { nome: 'Química do ENEM', quando: 'química, mol, estequiometria, balanceamento, reação, ácido, base, pH, soluções, concentração, orgânica, funções orgânicas, eletroquímica, termoquímica',
    instrucoes: 'Escreva a equação química balanceada antes de qualquer conta. Em estequiometria, monte a proporção em mols passo a passo (massa → mol → proporção → resposta). Em orgânica, diga a função e o nome oficial. Explique o conceito com um exemplo do cotidiano.' },
  { nome: 'Biologia com esquemas', quando: 'biologia, célula, genética, evolução, ecologia, fisiologia, corpo humano, botânica, zoologia, DNA, mitose, meiose',
    instrucoes: 'Explique com a sequência do processo em etapas numeradas (o que entra, o que acontece, o que sai). Use uma tabela quando for comparar (ex.: mitose × meiose). Destaque em negrito os termos que caem em prova e termine com uma pegadinha comum.' },
  { nome: 'História em linha do tempo', quando: 'história, revolução, guerra, império, república, era vargas, ditadura, colonização, independência, idade média, contexto histórico',
    instrucoes: 'Organize em: contexto (antes), causas, os fatos principais em linha do tempo com datas, consequências e a ligação com o presente. Cite nomes e datas só se tiver certeza. Termine com como o tema costuma cair no ENEM.' },
  { nome: 'Geografia do Brasil e do mundo', quando: 'geografia, clima, relevo, bioma, população, urbanização, globalização, agropecuária, industrialização, cartografia, fuso horário, escala',
    instrucoes: 'Explique relacionando causa e efeito (natureza, economia e sociedade). Use exemplos brasileiros. Em escala e fuso, faça a conta passo a passo. Quando fizer sentido, compare regiões numa tabela curta.' },
  { nome: 'Português e gramática', quando: 'gramática, português, crase, concordância, regência, pontuação, vírgula, ortografia, figura de linguagem, interpretação de texto, literatura',
    instrucoes: 'Dê a regra em uma frase, depois 3 exemplos certos e 1 errado corrigido. Em interpretação de texto, aponte o trecho que comprova a resposta. Em literatura, diga a escola literária, as características e um autor representativo.' },
  { nome: 'Inglês para o ENEM', quando: 'inglês, english, tradução, verbo, tempo verbal, phrasal verb, vocabulário, interpretação em inglês, gramática inglesa',
    instrucoes: 'Explique em português, com exemplos em inglês e a tradução de cada um. Em interpretação, destaque as palavras-chave e os falsos cognatos. Termine com 3 frases para a pessoa praticar (com as respostas no fim).' },
  { nome: 'Filosofia e Sociologia', quando: 'filosofia, sociologia, filósofo, sociólogo, ética, política, contrato social, marx, weber, durkheim, platão, aristóteles, kant, iluminismo',
    instrucoes: 'Apresente o autor, a época, o conceito central em linguagem simples e um exemplo atual. Quando comparar autores, use uma tabela. Termine com como o conceito aparece em questões do ENEM.' },
