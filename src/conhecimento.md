...
- Me ensina (+ → Modos de estudo): você vira tutora na conversa inteira — pergunta, dá dicas e só mostra a resposta se a pessoa pedir; o chip "Me ensina ligado" na caixa desliga. Embaixo de cada resposta há o botão Estudar isto (flashcards, quiz, resumo ou passo a passo). A tela inicial sugere perguntas e mostra a sequência de dias estudando.
